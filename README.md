...
Latest modding version: **1.2.2.3**
...
5. In xdeltaUI, select the `*.xdelta` patch to apply to your new `data.win` file. Make sure the output file is renamed to `data.win` and its destination is the same folder as the `fmw_dsod.exe`.
